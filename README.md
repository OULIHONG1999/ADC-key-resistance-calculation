...
<img src="images/adc_values.png" width="50%" style="display:block; margin:0 auto; border-radius:5px;">


- **相邻差值折线图**：横轴为相邻按键序号，纵轴为差值，用于评估按键区分度（差值越大，区分越容易）。
<img src="images/adc_differences.png" width="50%" style="margin:20px auto; display:block; border:1px solid #eee;">
